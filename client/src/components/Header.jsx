...
const Header = () => {
  ...
  return (
    <div className='flex flex-col  items-center mt-20 px-4 text-center'>
        ...
        <p className='mb-8 max-w-md'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem tempore commodi perspiciatis atque illo quisquam 
            aspernatur fuga velit, ipsa animi blanditiis suscipit iure inventore reiciendis est aliquam deserunt dignissimos saepe.</p>
